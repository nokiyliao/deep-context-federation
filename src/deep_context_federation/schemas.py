...
def _artifact_schemas() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "agent_context_gate": _schema(
            ...
            ["schema_version", "ok", "status", "authority_effect", "no_apply", "source_identity_policy", "policy", "checks", "errors", "summary"],
            {
                "ok": {"type": "boolean"},
        ...
        "agent_handoff": _schema(
            ...
            ],
            {
                ...
                **_boundary_props(),
                ...
                "unified_plane_audit_summary": object_type,
                "context_advantage_summary": object_type,
                "public_boundary_audit_summary": object_type,
        ...
        "agent_onboard": _schema(
            ...
            ],
            {
                ...
                **_boundary_props(),
                ...
                "model_input_ready": {"type": "boolean"},
                "entrypoint_decision": object_type,
                "model_entrypoint_selection": object_type,
                "model_entrypoint_selection_summary": object_type,
                "prompt_source": {"type": "string"},
                "prompt_estimated_tokens": {"type": "integer"},
                "recommended_next_command": {"type": "string"},
