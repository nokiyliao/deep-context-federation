...
NATIVE_CAPABILITY_ROWS: dict[str, dict[str, Any]] = {
    ...
    "summarize_operator_state": {
        ...
        "native_surfaces": [
            ...
            "operator_rows",
            "doctor_summary",
            "query_summaries.operator_projection",
        ...
        "remaining_gap": "Project-specific operator policies can still add stricter gates, but DCF now owns the first-class operator projection artifact.",
        "exit_criteria": [
            "operators and agents start from DCF summarize-operator-context or prepare-model-input output",
